...
* Conteúdo programático detalhado
  ...
  | 21,23,25/2 | Introdução linguagem C                   | Apresentação e Laboratório |
  | 7,9,11/3   | Arrays                                   | Apresentação e Laboratório |
  | 14,16,18/3 | Algoritmos                               | Apresentação e Laboratório |
